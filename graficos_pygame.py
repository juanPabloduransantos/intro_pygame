...
while 1:
    ...
    # rectangulo relleno, ubicado en la coordenada (200,200), y de ancho 200 y de altura 100

    pygame.draw.rect(ventana, rosado, (200,200,200,100))
    # rectangulo sin relleno, esquina sup. izq: (100,100), esquina, inf, der: (150,200). y de grosor1.
    pygame.draw.rect(ventana, verde, ((100,100), (150,200)), 1)

    # dibujar un poligono
    puntos3 = [(200,200), (250,300), (300,325), (400,350)]
    pygame.draw.polygon(ventana, amarillo, puntos1, 1)
    ...
    # dibuja una arco de sircunferencia
